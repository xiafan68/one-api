...
func TestReturnQuotaWhenUpStreamLLMFailed(t *testing.T) {
	...
	req.Header.Add("Authorization", "Bearer sk-KSUEE0r2AGsf8WKLE7Ab9d56539a40BfAbD295B87e410dDb")
	...
	assert.True(t, strings.Contains(string(body), "invalid_request_error"))
}
